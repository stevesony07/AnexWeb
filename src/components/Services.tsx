...
const ServiceCard = ({ 
  ...
  return (
    <div className="flex flex-col md:flex-row gap-6 p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 transform hover:scale-105 dark:border dark:border-gray-700 hover:shadow-blue-200/50 dark:hover:shadow-blue-900/30">
      ...
      <div className="flex-1">
        ...
        <a href="#" className="text-brand-blue dark:text-brand-lightBlue font-medium hover:underline inline-flex items-center group">
